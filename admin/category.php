...
echo "<table border='1'><th>Id</th><th>Short Desc</th><th>Long Desc</th><th>Active</th><th>Edit</th><th>Delete</th>";
$sql = "SELECT * FROM ".QCALENDAR_CAT_TABLE;
	$rs = mysql_query($sql);
	while ($rw = mysql_fetch_assoc($rs)) {
		...
		echo "$long_desc</td><td>$active</td><td><a href='category_update.php?id=$id'>edit</a></td><td><a href='category_update.php?del&id=$id'>del</a></td>";
		echo "</tr>";
	}
echo "</table>";
?>